...
const UUID = process.env.UUID || 'D3115297-344F-46B2-8AAA-9C0DD030286E'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'D3115297-344F-46B2-8AAA-9C0DD030286E/sub';            // 获取节点的订阅路径
